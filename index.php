    ...
    <div class="modal-dialog modal-full-height  modal-md" role="document">
      ...
      <div class="modal-body">
        ...
        <footer class="bg-light py-5">
            ...
            <br>
            <div class="container"><div class="small text-center text-muted">Copyright © 2024 - <?php echo $_SESSION['setting_name'] ?> | <a href="https://github.com/proloypoddar" target="_blank">PROLOY</a></div></div>
        </footer>
